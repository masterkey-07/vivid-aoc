      ...
      >
        ...
        >
          ...
          >
            ...
            <br></br>E se, ao tirar as roupas do cliente 1 da lavadora, já
            colocar as roupas do cliente 2 nela? E então, quando as roupas do 1
            saíssem da secadora, as roupas do 2 estariam prontas para iniciar a
            secagem, e assim consecutivamente. É nessa analogia que se baseia o
            conceito de Pipeline. As etapas a serem executadas nesse caso são:
            busca da instrução, decodificação da instrução, execução, acesso à
            memória e escrita de volta. Quando a busca da primeira é finalizada,
            já se pode iniciar a busca da segunda. Quando a decodificação da
            primeira é finalizada, se inicia a decodificação da segunda e busca
            da terceira.<br></br>
            <br></br>
