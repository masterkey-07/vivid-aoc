    ...
    <BasicContent>
      <div style={{ width: "100%", height: "100%", position: "relative" }}>
        ...
        <HelpCircle
          ...
          tooltipPosition={{ top: 95, left: 12 }}
        >
          ...
          gera sinais de controle precisos para direcionar os vários estágios de
          execução de instruções, garantindo que as operações sejam executadas
          em ciclos de clock específicos. A UC também desempenha um papel
          fundamental na seleção dos caminhos de dados corretos durante a
          execução das instruções MIPS multi-ciclo, garantindo que os sinais
          adequados sejam enviados aos multiplexadores nos momentos apropriados.
        </HelpCircle>
        ...
        >
          A ALU no MIPS multi-ciclo é responsável por realizar operações
        ...
        >
          ...
          dentro da CPU MIPS multi-ciclo, usados para armazenar dados
        ...
        >
          ...
          endereço da próxima instrução a ser buscada na memória. A UC controla
          o PC, garantindo que ele seja atualizado corretamente durante cada
          ciclo de clock para seguir a sequência de execução das instruções. O
          PC é essencial para garantir a execução ordenada das instruções em um
          pipeline de múltiplos ciclos.
        </HelpCircle>
      </div>
